...
const data:ProjectDetails = {
  ...
  body:[
    ...
    `One of my favorite parts of this project was learning about k-means clustering algorithms, which I realized I would need to implement in order to gather the different meters into groups, depending on the user's zoom settings and location.`,
